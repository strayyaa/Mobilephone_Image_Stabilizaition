...
if __name__ == '__main__':
    ...
    parser.add_argument('--moe_cutoff_ratio', type=float, default=0.02, help='MoE频段截断比例')
    parser.add_argument('--moe_frequency_residual_ratio', type=float, default=0.7, help='MoE频段残差注入系数')
    parser.add_argument('--moe_modal_residual_ratio', type=float, default=0.7, help='MoE模态融合残差注入系数（当前版本已由直接模态融合替代，仅保留参数以兼容旧脚本）')
    parser.add_argument('--moe_temperature', type=float, default=1.0, help='MoE softmax 温度')
