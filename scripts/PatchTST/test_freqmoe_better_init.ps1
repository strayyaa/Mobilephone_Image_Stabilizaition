# freqMOE test with better initialization + aux loss
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "imu_data_with_jitter_reduced.xlsx"
$model_id_name = "IMUDataFreqMoE_BetterInit"
$data_name = "imu"
$target = "yaw"
...
# freqMoE with better initialization
$freqmoe_experts = 4
$freqmoe_use_norm = 1
$freqmoe_use_soft_mask = 1
$freqmoe_sharpness = 30.0
$freqmoe_freq_wise_routing = 0
$freqmoe_balance_weight = 0.1

$model_id = $model_id_name + "_" + $seq_len + "_" + $pred_len

Write-Host "Running freqMOE with Better Init + Aux Loss..." -ForegroundColor Green
...
Write-Host "freqMOE Better Init completed!" -ForegroundColor Green
