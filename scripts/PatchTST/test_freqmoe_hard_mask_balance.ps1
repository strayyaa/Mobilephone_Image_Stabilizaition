# freqMOE test with hard mask + aux loss + balance weight
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "imu_data_with_jitter_reduced.xlsx"
$model_id_name = "IMUDataFreqMoE_HardMaskBalance"
$data_name = "imu"
$target = "yaw"
...
# freqMoE with hard mask + aux loss + balance weight
$freqmoe_experts = 4
$freqmoe_use_norm = 1
...
Write-Host "Running freqMOE with Hard Mask + Balance + Aux Loss..." -ForegroundColor Green
...
Write-Host "freqMOE Hard Mask Balance completed!" -ForegroundColor Green
