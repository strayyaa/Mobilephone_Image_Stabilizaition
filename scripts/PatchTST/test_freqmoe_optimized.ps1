# Quick freqMOE test with optimized parameters
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "imu_data_with_jitter_reduced.xlsx"
$model_id_name = "IMUDataFreqMoE_Optimized"
$data_name = "imu"
$target = "yaw"
...
Write-Host "Running freqMOE optimized..." -ForegroundColor Green
...
Write-Host "freqMOE optimized completed!" -ForegroundColor Green
