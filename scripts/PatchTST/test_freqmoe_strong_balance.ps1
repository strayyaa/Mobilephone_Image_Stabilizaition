# freqMOE test with strong balance weight
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "imu_data_with_jitter_reduced.xlsx"
$model_id_name = "IMUDataFreqMoE_StrongBalance"
$data_name = "imu"
$target = "yaw"
...
# freqMoE with strong balance weight
$freqmoe_experts = 4
$freqmoe_use_norm = 1
...
Write-Host "Running freqMOE with Strong Balance..." -ForegroundColor Green
...
Write-Host "freqMOE Strong Balance completed!" -ForegroundColor Green
