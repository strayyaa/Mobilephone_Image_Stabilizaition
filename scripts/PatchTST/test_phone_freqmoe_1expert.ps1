# freqMOE test - single expert (essentially just FFT normalization)
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "data.csv"
$model_id_name = "PhoneData_FreqMoE_1Expert"
$data_name = "angle"
$target = "x_angle_1"
...
# freqMoE with single expert (just FFT normalization effect)
$freqmoe_experts = 1
$freqmoe_use_norm = 1
...
Write-Host "Running freqMOE with 1 expert (FFT normalization)..." -ForegroundColor Green
...
Write-Host "freqMOE 1 expert completed!" -ForegroundColor Green
