# freqMOE test - 2 experts (low frequency split only)
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "data.csv"
$model_id_name = "PhoneData_FreqMoE_2Expert"
$data_name = "angle"
$target = "x_angle_1"
...
# freqMoE with 2 experts - focus on low freq split
$freqmoe_experts = 2
$freqmoe_use_norm = 1
...
Write-Host "Running freqMOE with 2 experts (low freq focus)..." -ForegroundColor Green
...
Write-Host "freqMOE 2 expert completed!" -ForegroundColor Green
