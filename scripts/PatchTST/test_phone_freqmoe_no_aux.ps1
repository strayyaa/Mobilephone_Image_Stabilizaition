# freqMOE test on data.csv - without aux loss
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "data.csv"
$model_id_name = "PhoneData_FreqMoE_NoAux"
$data_name = "angle"
$target = "x_angle_1"
...
Write-Host "Running freqMOE (no aux) on data.csv..." -ForegroundColor Green
...
Write-Host "freqMOE (no aux) completed!" -ForegroundColor Green
