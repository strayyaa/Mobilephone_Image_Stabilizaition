# MoE test on data.csv (mobile phone shaking dataset)
$seq_len = 200
$model_name = "PatchTST"
$root_path_name = "../../dataset/"
$data_path_name = "data.csv"
$model_id_name = "PhoneData_MoE"
$data_name = "angle"
$target = "x_angle_1"
...
Write-Host "Running MoE on data.csv (mobile phone dataset)..." -ForegroundColor Green
...
Write-Host "MoE on data.csv completed!" -ForegroundColor Green
